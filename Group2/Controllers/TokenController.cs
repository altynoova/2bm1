...
namespace Group2.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        {
            if (_userData != null && _userData.UserName != null && _userData.Passwords != null)
            {
        ...
        {
            return await _context.Users.FirstOrDefaultAsync(u => u.UserName == username && u.Passwords == password);
        }
    }
}
